...
<template>
    <div class="h-screen flex w-full bg-img">
        <div class="vx-col flex items-center justify-center flex-col sm:w-1/2 md:w-3/5 lg:w-3/4 xl:w-1/2 mx-auto text-center">
            ...
            <h1 class="sm:mx-0 mx-4 mb-6 text-5xl d-theme-heading-color">{{ $t('maintenance.title') }}</h1>
            <p class="sm:mx-0 mx-4 mb-6 d-theme-text-inverse">{{ $t('maintenance.description') }}</p>
            <vs-button size="large" to="/">{{ $t('maintenance.back_to_home') }}</vs-button>
        </div>
    </div>
</template>
