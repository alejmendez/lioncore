  ...
  <vs-sidebar click-not-close position-right parent="body" default-index="1" color="primary" class="add-new-data-sidebar items-no-padding" spacer v-model="isSidebarActiveLocal">
    ...
    <component :is="scrollbarTag" class="scroll-area--data-list-add-new" :settings="settings" :key="$vs.rtl">
      ...
      <div class="p-6">
        ...
        <!-- CATEGORY -->
        <vs-select v-model="dataCategory" label="Category" class="mt-5 w-full">
  ...
  watch: {
    isSidebarActive (val) {
      ...
      if (Object.entries(this.data).length === 0) {
        ...
        const { id, img, name, category } = JSON.parse(JSON.stringify(this.data))
        this.dataId = id
        this.dataImg = img
        this.dataName = name
      ...
      // Object.entries(this.data).length === 0 ? this.initValues() : { this.dataId, this.dataName, this.dataCategory, this.dataOrder_status } = JSON.parse(JSON.stringify(this.data))
    }
  },
  computed: {
    ...
    isFormValid () {
      return !this.errors.any() && this.dataName && this.dataCategory > 0
    },
