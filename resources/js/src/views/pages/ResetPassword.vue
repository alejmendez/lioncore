          ...
          <div class="vx-row">
            ...
            <div class="vx-col sm:w-full md:w-full lg:w-1/2 mx-auto self-center d-theme-dark-bg">
              <div class="p-8">
                ...
                <vs-input
                  type="email"
                  :label-placeholder="$t('reset_password.email')"
                  v-model="email"
                  class="w-full mb-6"
                />
                <vs-input
                  type="password"
                  :label-placeholder="$t('reset_password.password')"
                  v-model="password"
                  class="w-full mb-6"
                />
                <vs-input
                  type="password"
                  :label-placeholder="$t('reset_password.confirm_password')"
                ...
                <div class="flex flex-wrap justify-between flex-col-reverse sm:flex-row">
                  ...
                  >{{ $t('reset_password.go_to_back') }}</vs-button>
