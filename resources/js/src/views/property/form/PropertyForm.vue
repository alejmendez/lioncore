        ...
        <vx-card>
          <vs-row>
            <vs-col class="px-2" vs-w="12">
              <ValidationProvider class="w-full" name="property.name" rules="required|min:3|max:50" v-slot="{ errors, invalid, validated }">
                <vs-input
                  class="w-full mt-4"
                  v-model="data.name"
            ...
            <vs-col class="px-2" vs-w="12">
              <ValidationProvider class="w-full" name="property.value" rules="required|min:3" v-slot="{ errors, invalid, validated }">
                <vs-textarea
                  class="w-full mt-4"
                  v-model="data.value"
                  :danger="invalid && validated"
