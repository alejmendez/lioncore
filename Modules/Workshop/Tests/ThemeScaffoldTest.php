...
class ThemeScaffoldTest extends BaseTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->scaffold = $this->app['lioncore.theme.scaffold'];
    ...
    {
        $this->scaffold->setName($this->testThemeName)->forType('frontend')->setVendor('lioncore')->generate();
    }
    ...
    public function it_throws_exception_if_no_name_provided()
    {
        ...
        $this->scaffold->setName('')->forType('frontend')->setVendor('lioncore')->generate();
    }
    ...
    public function it_throws_exception_if_no_type_provided()
    {
        ...
        $this->scaffold->setName($this->testThemeName)->forType('')->setVendor('lioncore')->generate();
    }
    ...
    public function it_creates_composer_json_file()
    {
        ...
        $this->assertTrue(str_contains($this->finder->get($this->testThemePath . '/composer.json'), '"name": "lioncore/TestingTheme-theme",'));
    }
