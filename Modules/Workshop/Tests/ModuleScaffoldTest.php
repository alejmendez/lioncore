...
class ModuleScaffoldTest extends BaseTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->scaffold = $this->app['lioncore.module.scaffold'];
    }
    ...
    public function it_should_use_correct_vendor_name_in_composer_json()
    {
        ...
        $this->assertEquals('lioncore/testingthetestmodule', $composerJson->name);
    }

    /** @test */
    public function it_should_change_the_type_to_lioncore_module()
    {
        $this->scaffoldModuleWithEloquent();

        $composerJson = $this->getComposerFile();

        $this->assertEquals('lioncore-module', $composerJson->type);
    }
    ...
    {
        config()->set('lioncore.workshop.config.custom-stubs-folder', __DIR__ . '/stubs');
